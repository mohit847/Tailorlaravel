...
<div class="row breadcrumbs-top">
  <div class="breadcrumb-wrapper col-12"> <ol class="breadcrumb"> <li class="breadcrumb-item"><a
    ...
    </li> <li class="breadcrumb-item"><a href="javascript:void(0)">Expense Category</a> </li>
    <li class="breadcrumb-item active">All Expense Categories </li> </ol>
      </div> </div> @endpush @push('breadcrumb-button') <x-buttons.primary :text="'Add Category'"
        :target="'#add-category'" />
      @endpush
                ...
                <table class="table table-striped table-bordered dataex-html5-export">
                  ...
                  <tbody>
                    @if (!empty($categories->count()))
                        ...
                        @endforeach
                        <x-modals.delete :route="'expense-category.destroy'" :title="'Expense Category'" />
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <label class="modal-title text-text-bold-600" id="myModalLabel33">Edit Expense Category</label>
              <button type="button" class="close text-dark" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form method="post" action="{{route('expense-categories')}}">
              @csrf
              @method("PUT")
...
<!-- add expense category modal starts here -->
<div class="modal zoomIn text-left" id="add-category" tabindex="-1" role="dialog" aria-labelledby="AddCustomer"
  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <label class="modal-title text-text-bold-600" id="myModalLabel33">Add Expense Category</label>
        <button type="button" class="close text-dark" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
{{-- add expense category modal ends here --}}
@endsection
